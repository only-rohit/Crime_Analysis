"""
Utility Script for crime activity hotspots analysis

Usage :
The functions defined in this script work as helper functions in the main
source code notebook(../notebooks/main_nb.ipynb)
...
def create_df(filenames):
    ...
    print("Finished Loading Crime Dataset File for the year "+filenames[0][-8:-4]+".")
    main_df = main_df[list(main_df.columns[:22])]
    for file in filenames[1:]:
        print("Finished loading Crime Dataset file for the year "+file[-8:-4]+".")
